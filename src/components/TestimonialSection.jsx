...
function TestimonialSection() {
  return (
    <section className="bg-gray-50">
      <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-12 lg:py-28">
        <div className="md:flex md:items-end md:justify-between">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg leading-relaxed text-gray-700">
              Get to Know Our Esteemed Clients Who Reap The Reality of
              Difference We Deliver — Real People, Real Change!
            </p>
          </div>
